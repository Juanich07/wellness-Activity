...
5. **Push Notifications**
  ...
  - Add `GMAIL_USER`, `GMAIL_APP_PASSWORD`, and `APP_URL` to send schedule reminders by email as well (via Gmail SMTP, no custom domain required). Generate an App Password at https://myaccount.google.com/apppasswords for the Gmail account after enabling 2-Step Verification.
